...
namespace DesignPatterns\Other\ServiceLocator;
 ...
 * @package DesignPatterns\Other\ServiceLocator
 */
class ServiceLocator
{
    /**
    ...
    public function get(string $class): Service
    {
        ...
        if (!$object instanceof Service) {
            throw new InvalidArgumentException('Could not register service: is not instance of Service');
        }
